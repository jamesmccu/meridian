...
- **Image scan** (`trivy image ghcr.io/jamesmcculley/meridian-core:latest`) — scans the last published container image from main. Keeps the published image visible to CI between `build-sign.yml` runs.
