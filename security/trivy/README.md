...
- **Image scan** (`trivy image ghcr.io/jamesmcculley/meridian-core:latest`) — scans the last published container image from main. This scan is informational on PRs because `:latest` may not exist yet, may not be public, or may represent main rather than the PR.
